...
def create_post(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = 'Hello '+request.user.first_name+". Thank you for using django-crowdfunding. Make sure to share your post."
        ...
        form = PostForm()
    return render(request, 'crowdfunding/create_post.html', {'form': form})
...
def edit_post(request, author, url):
    ...
    return render(request, 'crowdfunding/create_post.html', {'form': form, 'post': post})
...
def delete_post(request, url):
    ...
    if post.author == request.user.username:
        ...
        message = 'Hello '+request.user.first_name+". Thank you for using django-crowdfunding. This email is to inform you that your post has been recently deleted from Django-Crowdfunding. If this was not done by you, please reply to this email and we will try to help you as best as we can"
        from_email = settings.DEFAULT_FROM_EMAIL
        recipient_list = [request.user.email]  # List of recipient email addresses
        send_mail(subject, message, from_email, recipient_list)
